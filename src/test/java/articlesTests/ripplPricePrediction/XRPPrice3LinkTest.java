...
public class XRPPrice3LinkTest extends AbstractTest {
    static Logger logger = LoggerFactory.getLogger(XRPPrice3LinkTest.class);
    ...
    @Test
    void xrpPrice3LinkTest() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) XRPPrice3LinkTest- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) XRPPrice3LinkTest- false");
        }
        logger.info("(Ripple price prediction 2022-2025) XRPPrice3LinkTest- passed");
    }
}
