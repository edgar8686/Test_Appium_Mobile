...
public class CryptocurrencyMarkets extends AbstractTest {
    static Logger logger = LoggerFactory.getLogger(CryptocurrencyMarkets.class);
    ...
    @Test
    void cryptocurrencyMarkets() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) CryptocurrencyMarkets- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) CryptocurrencyMarkets- false");
        }
        logger.info("(Ripple price prediction 2022-2025) CryptocurrencyMarkets- passed");
    }
}
