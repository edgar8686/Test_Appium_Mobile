...
public class NFTSLinkTest extends AbstractTest {
    ...
    @Test
    void nftsLinkTest() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) NFTSLinkTest- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) NFTSLinkTest- false");
        }
        logger.info("(Ripple price prediction 2022-2025) NFTSLinkTest- passed");
    }
}
