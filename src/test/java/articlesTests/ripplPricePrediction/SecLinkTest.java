...
public class SecLinkTest extends AbstractTest {
    ...
    @Test
    void secLinkTest() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) SecLinkTest- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) SecLinkTest- false");
        }
        logger.info("(Ripple price prediction 2022-2025) SecLinkTest- passed");
    }
}
