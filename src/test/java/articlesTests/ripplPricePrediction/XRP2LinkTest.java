...
public class XRP2LinkTest extends AbstractTest {
    static Logger logger = LoggerFactory.getLogger(XRP2LinkTest.class);
    ...
    @Test
    void xrp2LinkTest() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) XRP2LinkTest- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) XRP2LinkTest- false");
        }
        logger.info("(Ripple price prediction 2022-2025) XRP2LinkTest- passed");
    }
}
