...
public class TradingXRPLinkTest extends AbstractTest {
    static Logger logger = LoggerFactory.getLogger(TradingXRPLinkTest.class);
    ...
    @Test
    void tradingXRPLinkTest() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) TradingXRPLinkTest- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) TradingXRPLinkTest- false");
        }
        logger.info("(Ripple price prediction 2022-2025) TradingXRPLinkTest- passed");
    }
}
