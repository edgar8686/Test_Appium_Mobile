...
public class XRPPriceLinkTest extends AbstractTest {
    static Logger logger = LoggerFactory.getLogger(XRPPriceLinkTest.class);
    ...
    @Test
    void xrpPriceLinkTest() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) XRPPriceLinkTest- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) XRPPriceLinkTest- false");
        }
        logger.info("(Ripple price prediction 2022-2025) XRPPriceLinkTest- passed");
    }
}
