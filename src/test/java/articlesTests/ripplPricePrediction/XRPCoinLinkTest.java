...
public class XRPCoinLinkTest extends AbstractTest {
    static Logger logger = LoggerFactory.getLogger(XRPCoinLinkTest.class);
    ...
    @Test
    void xrpCoinLinkTest() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) XRPCoinLinkTest- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) XRPCoinLinkTest- false");
        }
        logger.info("(Ripple price prediction 2022-2025) XRPCoinLinkTest- passed");
    }
}
