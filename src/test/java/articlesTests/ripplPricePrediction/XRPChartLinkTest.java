...
public class XRPChartLinkTest extends AbstractTest {
    static Logger logger = LoggerFactory.getLogger(XRPChartLinkTest.class);
    ...
    @Test
    void xrpChartLinkTest() throws Exception {
        try {
            ...
            File file = MyUtils.makeScreenshot(getAndroidDriver(), "failure- org.example.articlesTests (Ripple price prediction 2022-2025) XRPChartLinkTest- False" + System.currentTimeMillis() + ".png");
            Allure.addAttachment("Screenshot", new ByteArrayInputStream(MyUtils.saveScreenshot(Files.readAllBytes(file.toPath()))));
            logger.error("(Ripple price prediction 2022-2025) XRPChartLinkTest- false");
        }
        logger.info("(Ripple price prediction 2022-2025) XRPChartLinkTest- passed");
    }
}
